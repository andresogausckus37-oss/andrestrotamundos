export const productosDigitales = [
  ...
  {
    id: "10-razas-perros-colorear",

    nombre: "10 Razas de Perros para Colorear",

    ventaCruzadaId: "10-razas-de-gatos-para-colorear",

    descripcion:
      "Pack descargable con 10 láminas imprimibles de distintas razas de perros, ideal para niños y adultos.",

    descripcionLarga:
      "Una colección de 10 ilustraciones de perros listas para imprimir y colorear. Cada lámina incluye una raza diferente y está diseñada en formato A4 para que puedas imprimirla fácilmente en casa o en una imprenta.",
    ...
    incluye: [
      "10 láminas individuales para colorear",
      "10 razas de perros",
      "Formato A4",
      "Archivo PDF digital",
  ...
  {
    id: "10-razas-de-gatos-para-colorear",

    nombre: "10 Razas de Gatos para Colorear",
    ...
    descripcionLarga:
      "Convierte cada momento en una experiencia creativa. Descubre 10 razas de gatos en láminas listas para imprimir y colorear, diseñadas para disfrutar en casa y dar rienda suelta a la imaginación. Recibes un archivo PDF en formato A4, práctico y listo para imprimir todas las veces que necesites. Elige tus colores, imprime tus láminas y empieza a crear.",
...

  {
    ...
    nombre: "50 Laberintos de Mascotas para Niños de 3 a 5 Años",

    ventaCruzadaId: "50-laberintos-toby-luna",

    descripcion:
      "50 laberintos imprimibles de mascotas para niños de 3 a 5 años, con dificultad progresiva.",

    descripcionLarga:
      "Una colección de 50 laberintos de mascotas de nivel fácil, diseñados para niños de 3 a 5 años. Los desafíos avanzan gradualmente de menor a mayor complejidad e incluyen diferentes personajes y objetivos. Ideal para estimular la concentración y desarrollar el razonamiento mientras se divierten.",
    ...
    imagenes: {
      portada:
        "https://wfcprfdtn1w76omy.public.blob.vercel-storage.com/laberintos/50%20laberintos%20mascotas%20/portada.webp",

      preview:
        "https://wfcprfdtn1w76omy.public.blob.vercel-storage.com/laberintos/50%20laberintos%20mascotas%20/preview-general.webp",

      previewsIndividuales: [
        "https://wfcprfdtn1w76omy.public.blob.vercel-storage.com/laberintos/50%20laberintos%20mascotas%20/preview1",
        "https://wfcprfdtn1w76omy.public.blob.vercel-storage.com/laberintos/50%20laberintos%20mascotas%20/preview2",
      ],
    },
